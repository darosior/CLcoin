...
"Copyright &copy; 2011-YYYY The CLcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About CLcoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>CLcoin</b> version", Q_NULLPTR));
